...
class ModifiedCosine(BaseSimilarity):
    ...
    def pair(self, reference: SpectrumType, query: SpectrumType) -> Tuple[float, int]:
        ...
        def get_matching_pairs():
            ...
            zero_pairs = collect_peak_pairs(spec1, spec2, self.tolerance, shift=0.0, mz_power=self.mz_power, intensity_power=self.intensity_power)
            ...
            nonzero_pairs = collect_peak_pairs(spec1, spec2, self.tolerance, shift=mass_shift, mz_power=self.mz_power, intensity_power=self.intensity_power)
