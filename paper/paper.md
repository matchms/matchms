...
Raw data can be imported from commonly used MGF files (via pyteomics [@levitsky_pyteomics_2019][@goloborodko_pyteomicspython_2013]), more convenient-to-handle json files (as provided by GNPS), as well as msp files. Future versions will further include support for mzML and mzXML, which currently can best be handled using pyteomics [@levitsky_pyteomics_2019] or pymzml [@kosters_pymzml_2018].
