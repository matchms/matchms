...
@pytest.mark.parametrize("adduct, parent_mass, precursor_mz, should_be_removed", [
...
def test_require_matching_adduct_precursor_mz_parent_mass(adduct, parent_mass, precursor_mz, should_be_removed):
    spectrum_in = SpectrumBuilder().with_metadata({"adduct": adduct, "parent_mass": parent_mass,
                                                   "precursor_mz": precursor_mz}).build()
