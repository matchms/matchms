...
@pytest.mark.parametrize(
    "smiles, adduct, precursor_mz, parent_mass, expected_precursor_mz, expected_parent_mass",
    [
...
def test_repair_parent_mass_is_molar_mass(
    smiles, adduct, precursor_mz, parent_mass, expected_precursor_mz, expected_parent_mass
):
    ...
    spectrum_in = (
        SpectrumBuilder()
        .with_metadata({"smiles": smiles, "adduct": adduct, "precursor_mz": precursor_mz, "parent_mass": parent_mass})
        .build()
    )
