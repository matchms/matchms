...
@pytest.mark.parametrize(
    "smiles, parent_mass, precursor_mz, adduct, "
    "expected_smiles, expected_parent_mass, expected_precursor_mz, expected_adduct",
    # Test repair parent mass is mol wt
    [
        ("CN1CCCC1C2=CN=CC=C2", 162.23, 163.23, "[M+H]+", "CN1CCCC1C2=CN=CC=C2", 162.115698455, 163.23, "[M+H]+"),
        ...
        ("C", 0.0, 17.5, "[M+H]+", "C", 16.031300128, 17.5, "[M+H+NH4]2+"),
    ],
)
def test_repair_parent_mass_match_smiles_wrapper(
    smiles,
    parent_mass,
    precursor_mz,
    adduct,
