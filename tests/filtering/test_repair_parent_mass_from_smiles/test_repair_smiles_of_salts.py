...
@pytest.mark.parametrize("smiles, parent_mass, expected_smiles, expected_salt_ions",
                         ...
                         [("C1=NC2=NC=NC(=C2N1)N.Cl", 135.054, "C1=NC2=NC=NC(=C2N1)N", "Cl"),
                          ...
                          # Not a salt
                          ("C(C(=O)O)C(CC(=O)O)(C(=O)O)O", 192.027, "C(C(=O)O)C(CC(=O)O)(C(=O)O)O",
                           None),
                          # All parts are incorrect
                          ("C(C(=O)O).C(C(=O)O)C(CC(=O)O)(C(=O)O)O", 150.0, "C(C(=O)O).C(C(=O)O)C(CC(=O)O)(C(=O)O)O",
                           None),
                          # Salt with > 3 parts
                          ("C(C(=O)O).C(C(=O)O)C(CC(=O)O)(C(=O)O)O.Cl", 192.027, "C(C(=O)O)C(CC(=O)O)(C(=O)O)O",
                           "C(C(=O)O).Cl"),
                          # Salt matching a combination of 2 parts
                          ("C(C(=O)O).C(C(=O)O)C(CC(=O)O)(C(=O)O)O.Cl", 228.0, "C(C(=O)O)C(CC(=O)O)(C(=O)O)O.Cl",
                           "C(C(=O)O)"),
                          ])
