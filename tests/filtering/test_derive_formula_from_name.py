...
@pytest.mark.parametrize("metadata, remove_formula_from_name, expected_formula, expected_compound_name", [
    [{"compound_name": "peptideXYZ [M+H+K] C5H12NO2"}, True, "C5H12NO2", "peptideXYZ [M+H+K]"],
    [{"compound_name": "peptideXYZ C5H12NO2", "formula": "totallycorrectformula"}, True, "totallycorrectformula", "peptideXYZ"],
