...
@pytest.mark.parametrize("metadata, expected_inchi, expected_inchikey, expected_smiles", [
    [
        ...
        {"inchi": "ABTNALLHJFCFRZ-UHFFFAOYSA-N"},
        "", "ABTNALLHJFCFRZ-UHFFFAOYSA-N", ""
    ], [
        {"inchikey": "ABTNALLHJFCFRZ-UHFFFAOYSA-N"},
        "", "ABTNALLHJFCFRZ-UHFFFAOYSA-N", ""
    ], [
        {"smiles": "ABTNALLHJFCFRZ-UHFFFAOYSA-N"},
        "", "ABTNALLHJFCFRZ-UHFFFAOYSA-N", ""
    ], [
        {"inchi": "C[C@H](Cc1ccccc1)N(C)CC#C"},
        "", "", "C[C@H](Cc1ccccc1)N(C)CC#C"
    ], [
        {"inchikey": "C[C@H](Cc1ccccc1)N(C)CC#C"},
        "", "", "C[C@H](Cc1ccccc1)N(C)CC#C"
    ], [
