...
def test_get_peak_intens_neighbourhood(intensities, expected_no_peaks_before, expected_no_peaks_after):
    peaks_before, peaks_after = _get_peak_intensity_neighbourhood(np.array(intensities))
...
def test_get_number_of_high_intensity_surrounding_peaks(intensities, mz, expected_no_peaks):
    number_of_high_intensity_surounding_peaks = _get_number_of_high_intensity_surrounding_peaks(
