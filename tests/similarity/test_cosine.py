...
def test_cosine_matrix_matches_flash_cosine_when_use_hungarian_false(use_collection):
...
@pytest.mark.parametrize("use_collection", [True, False])
def test_cosine_matrix_matches_hungarian_when_use_hungarian_true(use_collection):
    spectrum_1, spectrum_2, spectrum_3 = _make_test_spectra()
    spectra = [spectrum_1, spectrum_2, spectrum_3]
    if use_collection:
        spectra = SpectraCollection(spectra)
...
@pytest.mark.parametrize("use_collection", [True, False])
def test_cosine_matrix_score_field_selection(use_collection):
    spectrum_1, spectrum_2, spectrum_3 = _make_test_spectra()
    spectra = [spectrum_1, spectrum_2, spectrum_3]
...
def test_cosine_symmetric_matrix_has_expected_fields_and_shape(use_hungarian, use_collection):
    spectrum_1, spectrum_2, spectrum_3 = _make_test_spectra()
    spectra = [spectrum_1, spectrum_2, spectrum_3]
