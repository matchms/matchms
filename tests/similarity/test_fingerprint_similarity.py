...
def test_fingerprint_similarity_parallel(test_method, expected_score, array_type, set_empty):
    ...
    score_matrix = similarity_measure.matrix(
        [spectrum0, spectrum1, spectrum2], [spectrum0, spectrum1, spectrum2], array_type=array_type
    )
...
def test_fingerprint_similarity_with_scores_sorting():
    ...
    scores = calculate_scores([spectrum0, spectrum1, spectrum2], [spectrum0, spectrum1, spectrum2], similarity_measure)
