...
def test_binned_embedding_similarity_matrix():
    ...
    spectrum_1 = Spectrum(
        mz=np.array([100, 200, 300], dtype="float"), intensities=np.array([0.1, 0.2, 1.0], dtype="float")
    )
    spectrum_2 = Spectrum(
        mz=np.array([110, 190, 290], dtype="float"), intensities=np.array([0.5, 0.2, 1.0], dtype="float")
    )
...
def test_binned_embedding_similarity_euclidean():
    ...
    spectrum_2 = Spectrum(
        mz=np.array([110, 210, 310], dtype="float"), intensities=np.array([0.1, 0.2, 1.0], dtype="float")
    )
...
def test_binned_embedding_similarity_ann():
    ...
    query_spectrum = Spectrum(
        mz=np.array([100, 200, 300], dtype="float"), intensities=np.array([0.11, 0.21, 0.99], dtype="float")
    )
