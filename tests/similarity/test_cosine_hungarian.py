...
def test_cosine_hungarian_matrix_without_parameters():
    ...
    assert scores[0, 0]["score"] == scores[1, 1]["score"] == 1.0, "Expected different cosine score."
...
def test_cosine_hungarian_with_tolerance_0_2():
    ...
    spectrum_2 = Spectrum(
        mz=np.array([100, 300, 301, 511], dtype="float"), intensities=np.array([0.1, 1.0, 0.3, 0.4], dtype="float")
    )
...
def test_cosine_hungarian_case_where_greedy_would_fail():
    ...
    spectrum_1 = Spectrum(
        mz=np.array([100.005, 100.016], dtype="float"), intensities=np.array([1.0, 0.9], dtype="float"), metadata={}
    )

    spectrum_2 = Spectrum(
        mz=np.array([100.005, 100.01], dtype="float"), intensities=np.array([0.9, 1.0], dtype="float"), metadata={}
    )
...
def test_cosine_hungarian_case_without_matches():
    ...
    spectrum_1 = Spectrum(
        mz=np.array([100, 200], dtype="float"), intensities=np.array([1.0, 0.1], dtype="float"), metadata={}
    )

    spectrum_2 = Spectrum(
        mz=np.array([110, 210], dtype="float"), intensities=np.array([1.0, 0.1], dtype="float"), metadata={}
    )
