...
def likely_inchi_match(inchi_1, inchi_2, min_agreement = 3):
    ...
    The main 'defect' this method accounts for are missing '-' in the inchi.
...
def find_pubchem_match(compound_name, 
    ...
    if not corrected:    
        inchi_pubchem = None
        print("No matching inchi found for: " + inchi + "\n")
    
    return inchi_pubchem
